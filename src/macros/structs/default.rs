...
macro_rules! r#struct {
    (
        ...
        $(where
            ...
            fn from_bytes_pointer(bytes_pointer: *const u8, endianness: bool) -> Self {
                ...
                $(
                    let mut field_bytes = [0u8; <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE];
                    unsafe {
                        core::ptr::copy_nonoverlapping(bytes_pointer.add(_o), field_bytes.as_mut_ptr(), <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE);
                    }
                    let $field_identifier = <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::from_bytes(field_bytes,endianness);
                    _o = _o + <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE;
                )*
        ...
        $(where
            $($where_alias : $($where_boundary)::* $(<$($($where_boundary_generics)::*),*>)?),*
            [u8; <B as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE]:,
        )?
        {
            fn clone(&self) -> Self {
