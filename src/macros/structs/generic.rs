    ...
    ($(#[$($struct_doc:meta),*])* $vis:vis struct $struct_identifier:ident $(where $($where_clause:tt),*)? { $($(#[$field_doc:meta])* $field_visibility:vis $field_identifier:ident: $field_type:ty),*$(,)?}) => {
        ...
        impl $crate::traits::Bytes<crate::Origin, crate::Origin> for $struct_identifier {
            ...
            fn to_bytes(&self, endianness: bool) -> [u8; <Self as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE] {
                let mut b = [0u8; <Self as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE];
                let mut o = 0;
                // let _ = endianness;
                $(
                    b[o..(o+<$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE)].copy_from_slice(
                        &if endianness {
                    ...
                    o = o + <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE;
                )*
                b
            }
            ...
            fn from_bytes(bytes : [u8; <Self as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE], endianness: bool) -> Self {
                ...
                let _ = endianness;
                $(
                    let mut field_bytes = [0u8; <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE];
                    field_bytes.copy_from_slice(&bytes[_o..(_o+<$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE)]);
                    ...
                    _o = _o + <$field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE;
                )*
                Self {
                    $($field_identifier,)*
                }
        ...
        impl $crate::traits::Bytes<crate::Origin, crate::Origin> for Option<$struct_identifier> {
            const REPRESENTATION_SIZE: usize = <u8 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE + <$struct_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE;
            ...
            fn from_bytes(bytes: [u8; <Self as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE], endianness: bool) -> Self {
                ...
                if option == 0 {
                    ...
                    o = l;
                    l = l + <$struct_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE;
                    let mut value_bytes = [0u8; <$struct_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE];
        ...
        where
            ...
            [u8; <$struct_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE]:,
        {
