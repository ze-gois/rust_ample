    ...
    () => {
        impl $crate::traits::Bytes<crate::Origin, crate::Origin> for char {
            ...
            fn from_bytes_pointer(bytes_pointer: *const u8, endianness: bool) -> Self {
                let o = 0;
                let mut char_bytes = [0u8; <u32 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE];
                unsafe { core::ptr::copy_nonoverlapping(bytes_pointer.add(o), char_bytes.as_mut_ptr(), <u32 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE) };
