...
macro_rules! trait_implement_primitive_char_bytes {
    () => {
        impl $crate::traits::Bytes<crate::Origin, crate::Origin> for char {
            ...
            {
                if endianness {
                    <u32 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::to_le_bytes(
                        &(*self as u32),
                    )
                } else {
                    <u32 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::to_be_bytes(
                        &(*self as u32),
                    )
                }
            }
            fn from_bytes(
                ...
                let val = if endianness {
                    <u32 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::from_le_bytes(
                        bytes,
                    )
                } else {
                    <u32 as $crate::traits::Bytes<crate::Origin, crate::Origin>>::from_be_bytes(
                        bytes,
                    )
                };
