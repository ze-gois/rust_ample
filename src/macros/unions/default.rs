...
//                     b[..<$($field_type as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE)*].copy_from_slice(
...
//             fn from_bytes(bytes: [u8; <$union_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE], endianness: bool) -> $union_identifier {
//                 unsafe {
//                     let mut u = core::mem::MaybeUninit::<$union_identifier>::uninit();
//                     let ptr = u.as_mut_ptr() as *mut u8;
//                     core::ptr::copy_nonoverlapping(bytes.as_ptr(), ptr, <$union_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE);
//                     u.assume_init()
//                 }
//             }
...
//                 unsafe {
//                     let mut u = core::mem::MaybeUninit::<$union_identifier>::uninit();
//                     core::ptr::copy_nonoverlapping(bytes_pointer, u.as_mut_ptr() as *mut u8, <$union_identifier as $crate::traits::Bytes<crate::Origin, crate::Origin>>::REPRESENTATION_SIZE);
//                     u.assume_init()
//                 }
//             }
//         }
